   ...
   const token = localStorage.getItem("token");
    ...
    const Mother_GetAllHospitals = async() => {
        try {
                await axios.get(`${api}/api/hospitals`,{headers:{token}}).then((res) => {
                    setAllHospitals(res.data ? res.data : [])
                })
    ...
    const Owner_GetAllDoctor = async() => {
        try {
                ...
                await axios.get(`${api}/api/doctor/getAllDoctors`,{headers:{token}}).then((res) => {
                    setDoctors(res.data)
                })
    ...
    const Get_ByAttendence = async() =>{
        try {
            await axios.get(`${api}/api/inspector/getPatientControlsByAttendenceFalse`,{headers:{"Access-Control-Allow-Origin": "*",token}}).then((res) => {
                console.log(res);
    ...
    const Doctor_GetAllPatient = async() => {
        try {
            await axios.get(`${api}/api/inspector/getControls`,{headers:{token}}).then((res) => {
                console.log(res);
                setPatient(res.data)
            })
    ...
    const Doctor_GetAllVaccination = async() => {
        try {
                ...
                await axios.get(`${api}/api/doctor/vaccinations`,{headers:{token}}).then((res) => {
                    console.log(res);
    ...
    return(
        ...
        setName,setComment,setImageEmb,setBabyStatus,setNextDate,setAttendence,attendence,
